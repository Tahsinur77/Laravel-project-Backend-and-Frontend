        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/employee/edit/{{session('employeeId')}}/{{session('name')}}">Update profile</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <img class="card-img-top"src="{{asset('/storage/uploads/empDash/emplist.png')}}" alt="..." />
                    <div class="card-body p-4">
                        
                    </div>
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('employee.list')}}">Employee List</a></div>
                    </div>
                </div>
            </div>
            <div class="col mb-5">
                <div class="card h-100">
                    <img class="card-img-top"src="{{asset('/storage/uploads/empDash/addEmp.png')}}" alt="..." />
                    <div class="card-body p-4">
                        
                    </div>
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('employee.registration')}}">Add New Employee</a></div>
                    </div>
                </div>
            </div>
        </div>
